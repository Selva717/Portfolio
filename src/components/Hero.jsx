...
const Hero = () => {
    const [text] = useTypewriter({
        words:['am Selva kumar ','am a Full-Stack Developer'],
        loop:{},
        typeSpeed:120,
        deleteSpeed:80
    })
  return (
    ...
    {/* laptop screen */}
        <div className=' hide1 w-[80%] mx-[auto] my-[120px] flex gap-5 items-center'>
            <div >
                <div className='font-heading text-5xl font-medium mb-5'>Hi i <span className='text-[green] font-heading font-bold'>{text}<Cursor/></span></div>
