...
export const Contact = () => {
  ...
  return (
    <div className=' mx-auto mt-[10px] relative mb-[120px]'>
      <div className='text-center m-10 font-bold font-heading text-3xl max-[450px]:text-xl' data-aos='flip-down'>📩 Let's Connect!</div>
      ...
      <form ref={form} onSubmit={sendEmail}  data-aos='zoom-in'>
        <div className='flex gap-12 justify-center max-[450px]:gap-2'>
          ...
          <div className='flex flex-col gap-12 '>
            <input className='border border-solid border-black px-4 max-[450px]:px-2 py-1 rounded-[4px]' required type="text" name="from_name" placeholder='eg.selva' />
            <input className='border border-solid border-black px-4 max-[450px]:px-2 py-1 rounded-[4px]' required type="email" name="from_email" placeholder='eg.selva@gmail.com' />
