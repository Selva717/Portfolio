    ...
    <div className='w-[80%]  mx-auto my-[80px]' >
        ...
        <div data-aos='fade-right' className='mt-11' >
            ...
            <div className='flex gap-2 items-center mb-3'>
                ...
                <div className='text-[gray]'>JAN-2024 to APR-2024</div>
            </div>
            <div className=' font-para text-xl font-medium text-justify max-[600px]:text-[19px]'>I completed my internship at a startup called iamneo, an EdTech company, where I worked as a SED intern. During my time at iamneo, I utilized a technology stack that included React, REST APIs, and Tailwind CSS to enhance the platform's functionality and user experience.</div>
